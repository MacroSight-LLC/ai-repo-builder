...
export function StatusBar({ threadId }: StatusBarProps) {
  ...
  const examplesPopupTimeoutRef = useRef<ReturnType<typeof setTimeout> | null>(
    null,
  );
            ...
            <div className="config-modal-content">
              ...
              >
                {subAgents.filter((a) => a.enabled).length === 0 ? (
                  ...
                  >
                    No active agents available. Enable agents in Sub Agents
                    configuration.
                  </div>
                ) : (
                  subAgents
                            ...
                            <div className="tool-group-header">
                              ...
                              <div className="tool-group-stats">
                                <span className="tool-group-count">
                                  Connected: {data.connected}/{data.total}
                                </span>
                                {internalToolsCount[type.toLowerCase()] !==
                                  undefined && (
                        ...
                        <>
                          <div className="agents-info-box">
                            <span className="agents-info-label">
                              Available Sub-Agents (click to toggle):
                            </span>
                          </div>
                          {subAgents.map((agent) => (
                            <div
                        ...
                        {selectedAgent ? (
                          <>
                            <span className="single-agent-label">
                              Talking with: {getSelectedAgentInfo()?.name}
                            </span>
